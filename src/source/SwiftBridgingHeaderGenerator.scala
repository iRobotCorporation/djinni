...
class SwiftBridgingHeaderGenerator(spec: Spec) extends Generator(spec) {
  ...
  override def generateInterface(idl: Seq[djinni.ast.TypeDecl], origin: String, ident: djinni.ast.Ident, doc: djinni.ast.Doc, typeParams: Seq[djinni.ast.TypeParam], i: djinni.ast.Interface) {
    spec.objcSwiftBridgingHeaderWriter.get.write("#import \"" + marshal.headerName(ident) + "\"\n")
  }
